                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition validation-field">
                                    <span class="error-msg"></span>
                                </div>
                            </div>
