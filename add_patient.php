<?php
include __DIR__ . '/controllers/add_patient_data.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="flex h-screen overflow-hidden">
    ...
    <main class="flex-1 overflow-auto">
        <div class="p-8 max-w-5xl mx-auto">
            <div class="mb-8">
                <a href="users_list.php" class="inline-flex items-center text-sm text-gray-500 hover:text-green-600 mb-2 transition">
            ...
            <form id="addPatientForm" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8" novalidate>
                <!-- Image & Credentials Section -->
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                        ...
                        <div class="space-y-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="username" required class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition text-sm validation-field">
                                <span class="error-msg"></span>
                            </div>
                            <div class="form-group">
                                <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Password <span class="text-red-500">*</span></label>
                                <input type="password" name="password" id="password" required class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition text-sm validation-field">
                                <span class="error-msg"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" id="first_name" required class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition validation-field">
                                <span class="error-msg"></span>
                            </div>
                            <div class="form-group">
                                <label class="block text-sm font-bold text-gray-700 mb-2">Middle Name</label>
                                <input type="text" name="middle_name" id="middle_name" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition validation-field">
                                <span class="error-msg"></span>
                            </div>
                            <div class="form-group">
                                <label class="block text-sm font-bold text-gray-700 mb-2">Last Name <span class="text-red-500">*</span></label>
                                <input type="text" name="last_name" id="last_name" required class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition validation-field">
                                <span class="error-msg"></span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="bdate" id="bdate" required class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition validation-field">
                                <span class="error-msg"></span>
                            </div>
                            <div class="form-group">
                                <label class="block text-sm font-bold text-gray-700 mb-2">Gender <span class="text-red-500">*</span></label>
                                <select name="gender" id="gender" required class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition validation-field">
                        ...
                        <div class="form-group mb-8">
                            ...
                            <input type="text" name="contact" id="contact" required class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition validation-field">
                        ...
                        <div class="form-group mb-8">
                            ...
                            <textarea name="address" id="address" rows="2" required class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-green-500 outline-none transition validation-field"></textarea>
                            <span class="error-msg"></span>
                        </div>
    ...
    <script src="js/add_patient.js" defer></script>
