...
if ($apt_id <= 0) die("Invalid appointment ID.");
...
switch ($status) {
    case 1: $status_label = "Confirmed"; $status_badge = "bg-green-100 text-green-700 border-green-200"; $icon = "check-circle"; break;
    case 2: $status_label = "Pending";   $status_badge = "bg-yellow-50 text-yellow-700 border-yellow-200"; $icon = "clock"; break;
    case 3: $status_label = "Completed"; $status_badge = "bg-blue-50 text-blue-700 border-blue-200"; $icon = "check-circle-2"; break;
    default: $status_label = "Cancelled"; $status_badge = "bg-red-50 text-red-700 border-red-200"; $icon = "x-circle"; break;
}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-4">
                        <img src="<?= $doc_img ?>" class="w-16 h-16 rounded-full object-cover border-2 border-blue-100 shadow-sm">
                        <div>
