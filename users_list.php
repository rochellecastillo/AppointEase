    ...
    <main class="flex-1 overflow-auto">
      <div class="p-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <a href="register_patient.php" class="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-5 py-2.5 rounded-xl shadow-lg shadow-green-200 transition flex items-center gap-2 font-medium">
