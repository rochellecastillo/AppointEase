...
// Helper for Avatar
$avatar = !empty($patient['image']) ? 'uploads/' . e($patient['image']) : 'https://ui-avatars.com/api/?name=' . urlencode($patient['first_name'] . '+' . $patient['last_name']) . '&background=random';

function val($key, $data) { return !empty($data[$key]) ? e($data[$key]) : '<span class="text-slate-400 italic">None</span>'; }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-auto w-full">
            ...
            <div class="p-6 md:p-8 max-w-5xl mx-auto">
                ...
                <div class="mb-8">
                    <a href="patients.php" class="inline-flex items-center text-sm text-slate-500 hover:text-green-600 mb-4 transition">
                    ...
                    <div class="flex flex-col md:flex-row gap-6 items-start md:items-center">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-slate-900"><?= e($patient['first_name'] . ' ' . $patient['last_name']) ?></h1>
                            <p class="text-slate-500">ID: <?= e($patient_id) ?> &bull; <?= $age ?> Years Old &bull; <?= ucfirst(e($patient['gender'])) ?></p>
                        </div>
