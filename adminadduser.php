...
<head>
  ...
  <title>AppointEase - Add Doctor</title>
...
<body class="text-secondary">
  ...
  <div class="container py-4">
    <div class="card mx-auto" id="login-container" style="max-width:900px;">
      <div class="card-body">
        <h4 class="card-title mb-3"><i class="fa-solid fa-user-plus"></i> Add Doctor</h4>
    ...
    $('#addDoctorForm').on('submit', function(e){
      ...
      $.ajax({
        ...
        success: function(resp){
          $('#btnSubmit').prop('disabled', false).text('Add Doctor');
          if(resp.success){
            Swal.fire({ icon: resp.icon || 'success', title: 'Add Doctor', text: resp.message });
