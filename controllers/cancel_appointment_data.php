<?php
// client_appointments.php - Enhanced Appointment Management (updated)
// ---------------------------------------------------------
...
// Ensure helper e() exists (security_helper usually provides it)
...
try {
    $stmt = $pdo->prepare("
        SELECT a.id, a.booking_date, a.booking_time, a.status, a.doctor,
